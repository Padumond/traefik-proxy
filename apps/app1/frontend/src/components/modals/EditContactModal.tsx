...
export default function EditContactModal({
  ...
  useEffect(() => {
    if (contact) {
      ...
      // Extract group names from contact groups
      const contactGroupNames =
        contact.groups?.map((g: any) => g.name || g) || [];

      // Extract custom fields - handle both object and null cases
      const customFields = contact.customFields || {};

      // Ensure we handle the case where customFields might be null or undefined
      const company =
      ...
      setFormData({
        ...
        company,
        birthDate,
        selectedGroups: contactGroupNames,
      });
    }
  }, [contact]);
